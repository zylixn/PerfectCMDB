...
setup(
    ...
    packages=['API', 'cmdb', 'cmdb.migrations', 'cmdb.templatetags', 'venv.Lib.distutils', 'venv.Lib.encodings',
              ...
              'venv.Lib.site-packages.pytz', 'venv.Lib.site-packages.redis', 'venv.Lib.site-packages.wheel',
              ...
              'venv.Lib.site-packages.django_redis', 'venv.Lib.site-packages.django_redis.client',
              'venv.Lib.site-packages.django_redis.compressors', 'venv.Lib.site-packages.django_redis.serializers',
              ...
              'common.DevPub', 'common.OraPub', 'monitor', 'monitor.migrations', 'kingadmin', 'autodeploy',
              'autodeploy.migrations', 'CMDBClient.bin', 'CMDBClient.conf', 'CMDBClient.core', 'CMDBClient.plugin',
              'CMDBClient.plugin.linux', 'CMDBClient.plugin.windows', 'PerfectCMDB'],
    url='http://127.0.0.1:9000/cmdb/',
    license='',
    author='lixn',
    author_email='lixn@zhong-ying.com',
    description='test'
)
