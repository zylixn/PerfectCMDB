    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('deploy_asset', 'Can deploy asset'), ('webssh_asset', 'Can webssh asset'), ('grep_asset', 'Can grep asset'), ('run_sh_asset', 'Can run_sh asset'), ('run_cmd_asset', 'Can run_cmd asset'), ('other_do_asset', 'Can other_do asset')),
            },
        ),
        migrations.CreateModel(
            name='AssetGroup',
        ...
        migrations.AddField(
            model_name='asset',
            name='credential',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cmdb.Credential'),
        ),
        migrations.AddField(
            model_name='asset',
            name='group',
            field=models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cmdb.AssetGroup', verbose_name='组/安全区域'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
        ...
        migrations.AddField(
            model_name='asset',
            name='usergroup',
            field=models.ManyToManyField(blank=True, help_text='网站哪些用户组可以对主机进行操作', to='auth.Group', verbose_name='网站用户组'),
        ),
        migrations.AddField(
